# Aplicativo [Quadro Tático de Futsal](https://play.google.com/store/apps/details?id=com.prancheta.quadrotaticodefutsal)
...
<ul>
    ...
    <li>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do aplicativo "Quadro Tático de Futsal", de seus
...
<h2>1. Termos</h2>
<p>Ao acessar ao aplicativo "Quadro Tático de Futsal", o usuário concorda em cumprir estes termos de serviço, todas as leis, regulamentos 
...
<ol>
    ...
    <li>tentar descompilar ou fazer engenharia reversa de qualquer software contido no aplicativo "Quadro Tático de Futsal"; 
    </li>
...
<ol>
    <li>Os materiais no aplicativo "Quadro Tático de Futsal" são fornecidos 'como estão'. O "Quadro Tático de Futsal" não oferece
...
<p>Os materiais exibidos no aplicativo "Quadro Tático de Futsal" podem incluir erros técnicos, tipográficos ou fotográficos.
    O "Quadro Tático de Futsal" não garante que qualquer material em seu aplicativo seja preciso, completo ou atual. O "Quadro Tático
